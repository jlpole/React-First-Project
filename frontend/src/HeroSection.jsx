...
import Section from './Logo/Office.jpg';
        ...
        <div className="relative w-full max-w-7xl h-[400px]">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-4">
            <h1 className="text-3xl font-bold mb-4">
              Browse business and products.
            </h1>
               <button
      onClick={() => navigate('/MarketerRegister')}
      className="bg-yellow-400 text-green-900 px-4 py-2 rounded-lg font-bold hover:bg-yellow-300 transition"
    >
      Sign Up
    </button>
